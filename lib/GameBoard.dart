...
class _GameBoardScreenState extends State<GameBoardScreen> {
  ...
  void onButtonClicked(int index) {
    if (buttonsText[index].isNotEmpty) return;
  ...
  String checkWinner(String symbol) {
    for (int i = 0; i <= 2; i++) {
      if (buttonsText[i * 3] == symbol &&
          buttonsText[(i * 3) + 1] == symbol &&
          buttonsText[(i * 3) + 2] == symbol) {
        return symbol;
      }
    }
    for (int i = 0; i <= 2; i++) {
      if (buttonsText[i] == symbol &&
          buttonsText[(i + 3)] == symbol &&
          buttonsText[i + 6] == symbol) {
        return symbol;
      }
    }
    if (buttonsText[0] == symbol &&
        buttonsText[4] == symbol &&
        buttonsText[8] == symbol) {
      return symbol;
    }
    if (buttonsText[2] == symbol &&
        buttonsText[4] == symbol &&
        buttonsText[6] == symbol) {
      return symbol;
    }
    return 'No Winner';
  }
